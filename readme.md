...
This is the **Tensorflow code** for our paper [Patch-wise Attack++: Boosting Adversarial Targeted Attacks with Temperature](http://arxiv.org/abs/2007.06765), and **Pytorch version can be easily extended at [here](https://github.com/qilong-zhang/Patch-wise-iterative-attack/tree/master/Pytorch%20version)**.
